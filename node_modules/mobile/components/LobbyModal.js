  ...
  return (
    ...
    >
      <View style={[styles.overlay, {
        backgroundColor: theme.mode === 'dark' ? 'rgba(0,0,0,0.5)' : 'rgba(255,255,255,0.3)'
      }]}>
          ...
          {['normal', 'event'].map(type => (
            ...
            >
              ...
              <Text style={{ color: theme.text }}>
                {type === 'normal' ? 'Normal Lobi' : 'Etkinlik Lobisi'}
              </Text>
            </TouchableOpacity>
          ))}
            ...
            <View style={styles.dateSection}>
              ...
              >
                <View style={styles.rowCenter}>
                  ...
                  <Text style={{ color: theme.text }}>
                    Başlangıç: {eventStartDate.toLocaleDateString()}
                  </Text>
                </View>
              </TouchableOpacity>
              {showStartPicker && (
              ...
              >
                <View style={styles.rowCenter}>
                  <Feather name="calendar" size={18} color={theme.text} style={{ marginRight: 6 }} />
                  <Text style={{ color: theme.text }}>
                    Bitiş: {eventEndDate.toLocaleDateString()}
                  </Text>
                </View>
              </TouchableOpacity>
              {showEndPicker && (
          ...
          {!skipGameSelection && (
            <>
              ...
              <Picker
                ...
                onValueChange={(value) =>
                  setSelectedGame(games.find(g => g.id === value) || null)
                }
                style={{
